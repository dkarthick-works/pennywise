...
func (s *Server) Router() http.Handler {
	...
	r.Group(func(pr chi.Router) {
		...
		pr.Post("/api/reserve-operations/income-transfers", s.handleCreateReserveIncomeTransfer)
		pr.Post("/api/reserve-operations/funded-expenses", s.handleCreateFundedExpense)
		pr.Post("/api/reserve-operations/transfers", s.handleCreateReserveTransfer)
		pr.Get("/api/income-activity", s.handleIncomeActivity)
		pr.Patch("/api/reserve-operations/{id}", s.handleUpdateReserveOperation)
		pr.Post("/api/reserve-operations/{id}/convert-to-income", s.handleConvertReserveDepositToIncome)
		pr.Post("/api/transactions/{id}/convert-to-reserves", s.handleConvertIncomeToReserves)
		pr.Delete("/api/reserve-operations/{id}", s.handleDeleteReserveSpending)
		pr.Delete("/api/reserve-transfers/{id}", s.handleDeleteReserveTransfer)
		pr.Post("/api/reserves/{id}/archive", s.handleArchiveReserve)
		pr.Delete("/api/reserves/{id}", s.handleDeleteReserve)
